...
```bash
git clone https://github.com/SreeCharanManne/StandardPlantShopee.git
cd StandardPlantShopee
```
...
Developed by [Sree Charan Manne](https://github.com/SreeCharanManne)
